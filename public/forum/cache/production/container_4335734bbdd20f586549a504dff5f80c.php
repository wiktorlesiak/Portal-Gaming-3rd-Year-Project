...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000004801dc73000000004aa37b41(
...
class phpbbtemplatetwiglexer_000000004801dc73000000004aa37b41 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5adf7d6ba01f2118434315 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5adf7d6ba01fa416430269 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5adf7d6ba01d8911410894 = array(
    ...
    {
        $this->initializer5adf7d6ba01fa416430269 && ($this->initializer5adf7d6ba01fa416430269->__invoke($valueHolder5adf7d6ba01f2118434315, $this, 'set_environment', array('env' => $env), $this->initializer5adf7d6ba01fa416430269) || 1) && $this->valueHolder5adf7d6ba01f2118434315 = $valueHolder5adf7d6ba01f2118434315;

        return $this->valueHolder5adf7d6ba01f2118434315->set_environment($env);
    }
    ...
    {
        $this->initializer5adf7d6ba01fa416430269 && ($this->initializer5adf7d6ba01fa416430269->__invoke($valueHolder5adf7d6ba01f2118434315, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5adf7d6ba01fa416430269) || 1) && $this->valueHolder5adf7d6ba01f2118434315 = $valueHolder5adf7d6ba01f2118434315;

        return $this->valueHolder5adf7d6ba01f2118434315->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5adf7d6ba01fa416430269 && ($this->initializer5adf7d6ba01fa416430269->__invoke($valueHolder5adf7d6ba01f2118434315, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5adf7d6ba01fa416430269) || 1) && $this->valueHolder5adf7d6ba01f2118434315 = $valueHolder5adf7d6ba01f2118434315;

        return $this->valueHolder5adf7d6ba01f2118434315->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5adf7d6ba01fa416430269 = $initializer;
    }
    ...
    {
        $this->initializer5adf7d6ba01fa416430269 && ($this->initializer5adf7d6ba01fa416430269->__invoke($valueHolder5adf7d6ba01f2118434315, $this, '__get', array('name' => $name), $this->initializer5adf7d6ba01fa416430269) || 1) && $this->valueHolder5adf7d6ba01f2118434315 = $valueHolder5adf7d6ba01f2118434315;

        if (isset(self::$publicProperties5adf7d6ba01d8911410894[$name])) {
            return $this->valueHolder5adf7d6ba01f2118434315->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5adf7d6ba01f2118434315;
    ...
    {
        $this->initializer5adf7d6ba01fa416430269 && ($this->initializer5adf7d6ba01fa416430269->__invoke($valueHolder5adf7d6ba01f2118434315, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5adf7d6ba01fa416430269) || 1) && $this->valueHolder5adf7d6ba01f2118434315 = $valueHolder5adf7d6ba01f2118434315;
    ...
    {
        $this->initializer5adf7d6ba01fa416430269 && ($this->initializer5adf7d6ba01fa416430269->__invoke($valueHolder5adf7d6ba01f2118434315, $this, '__isset', array('name' => $name), $this->initializer5adf7d6ba01fa416430269) || 1) && $this->valueHolder5adf7d6ba01f2118434315 = $valueHolder5adf7d6ba01f2118434315;
    ...
    {
        $this->initializer5adf7d6ba01fa416430269 && ($this->initializer5adf7d6ba01fa416430269->__invoke($valueHolder5adf7d6ba01f2118434315, $this, '__unset', array('name' => $name), $this->initializer5adf7d6ba01fa416430269) || 1) && $this->valueHolder5adf7d6ba01f2118434315 = $valueHolder5adf7d6ba01f2118434315;
    ...
    {
        $this->initializer5adf7d6ba01fa416430269 && ($this->initializer5adf7d6ba01fa416430269->__invoke($valueHolder5adf7d6ba01f2118434315, $this, '__clone', array(), $this->initializer5adf7d6ba01fa416430269) || 1) && $this->valueHolder5adf7d6ba01f2118434315 = $valueHolder5adf7d6ba01f2118434315;

        $this->valueHolder5adf7d6ba01f2118434315 = clone $this->valueHolder5adf7d6ba01f2118434315;
    }

    public function __sleep()
    {
        $this->initializer5adf7d6ba01fa416430269 && ($this->initializer5adf7d6ba01fa416430269->__invoke($valueHolder5adf7d6ba01f2118434315, $this, '__sleep', array(), $this->initializer5adf7d6ba01fa416430269) || 1) && $this->valueHolder5adf7d6ba01f2118434315 = $valueHolder5adf7d6ba01f2118434315;

        return array('valueHolder5adf7d6ba01f2118434315');
    }
    ...
    {
        return $this->initializer5adf7d6ba01fa416430269;
    }
    ...
    {
        return $this->initializer5adf7d6ba01fa416430269 && ($this->initializer5adf7d6ba01fa416430269->__invoke($valueHolder5adf7d6ba01f2118434315, $this, 'initializeProxy', array(), $this->initializer5adf7d6ba01fa416430269) || 1) && $this->valueHolder5adf7d6ba01f2118434315 = $valueHolder5adf7d6ba01f2118434315;
    }
    ...
    {
        return null !== $this->valueHolder5adf7d6ba01f2118434315;
    }
    ...
    {
        return $this->valueHolder5adf7d6ba01f2118434315;
    }
